...
<script>
  ...
  const sides = [
    ...
    function () {
      this.style = 'top: 10px; right: 10px; bottom: unset; left: unset;';
    },
    function () {
      this.style = 'bottom: 10px; left: 10px; top: unset; right: unset;';
    },
    function () {
      this.style = 'bottom: 10px; right: 10px; top: unset; left: unset;';
    },
    function () {
      this.style = 'top: 10px; left: 10px; bottom: unset; right: unset;';
